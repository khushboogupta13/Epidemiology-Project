...
raw_data = [line.strip() for line in open(data_file)]
data = raw_data[1:]
birmingham = []
staffordshire = []
coventry = []
...
def make_date():
    ...
    february = ["2020-02-" + y for y in dates[11:-2]]
    march = ["2020-03-" + y for y in dates]
    april = ["2020-04-" + y for y in dates[:-1]]
    may = ["2020-05-" + y for y in dates]
    june = ["2020-06-" + y for y in dates[:20]]
    return february + march + april + may + june
